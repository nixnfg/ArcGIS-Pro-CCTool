...
{
    /// <summary>
    /// Interaction logic for YZT_DC.xaml
    /// </summary>
    public partial class YZT_DC : ArcGIS.Desktop.Framework.Controls.ProWindow
    {
        public YZT_DC()
        {
            InitializeComponent();
                        ...
                        using (RowCursor rowCursor = featureClass.Search())
                        {
                            while (rowCursor.MoveNext())
                            {
                                using (Feature feature = rowCursor.Current as Feature)
                                {
                                    ...
                                    string ft_bh = "";
                                    if (field_lx != "") { ft_bh = row[field_bh]?.ToString() ?? ""; }
                                    ...
                                    string title = $"{ft_bh},{ft_mc},{ft_lx},,@" + "\r\n";
                                    txt_all += title;
        ...
        private void combox_mj_Open(object sender, EventArgs e)
        {
            ...
            UITool.AddTextFieldsToCombox(shpPath, combox_mj);
        }
