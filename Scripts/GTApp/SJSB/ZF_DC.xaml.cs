...
{
    /// <summary>
    /// Interaction logic for ZF_DC.xaml
    /// </summary>
    public partial class ZF_DC : ArcGIS.Desktop.Framework.Controls.ProWindow
    {
        public ZF_DC()
        {
            InitializeComponent();
            ...
            combox_digit.Items.Add("7");
            combox_digit.Items.Add("8");
            combox_digit.Items.Add("9");
            combox_digit.Items.Add("10");
            combox_digit.SelectedIndex = 2;
        }

        // 定义一个进度框
        private ProcessWindow processwindow = null;
        string tool_name = "卫片执法要素转TXT";
        ...
        private async void btn_go_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string field_lx = combox_mj.Text;
                        ...
                        using (RowCursor rowCursor = featureClass.Search())
                        {
                            while (rowCursor.MoveNext())
                            {
                                using (Feature feature = rowCursor.Current as Feature)
                                {
                                    ...
                                    string title = $"{count},{ft_mc},{ft_lx},{ft_yt},@" + "\r\n";
                                    txt_all += title;
        ...
        private void combox_mc_Open(object sender, EventArgs e)
        {
            try
            {
                ...
                UITool.AddFieldsToCombox(shpPath, combox_mc);
        ...
        private void combox_yt_Open(object sender, EventArgs e)
        {
            try
            {
                ...
                UITool.AddFieldsToCombox(shpPath, combox_yt);
            }
            catch (Exception ee)
            {
                MessageBox.Show(ee.Message + ee.StackTrace);
        ...
        private void combox_time_Open(object sender, EventArgs e)
        {
            ...
            UITool.AddFieldsToCombox(shpPath, combox_time);
        }
    }
}
